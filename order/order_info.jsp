...
<div class="form-group row">
	...
	<div class="col-sm-3">
        ...
        for (i = 0; i < digits - n.length; i++)
            ...
            document.getElementById('shippingDate').min = todaydate;
        </script>
	</div>
	  </div>
	 <div class="form-group row">
	...
	<div class="form-group row">
	   <label class="col-sm-2">우편번호</label>
	     <div class="col-sm-3">
	 	<input type="text" name="zipCode" placeholder="우편번호" class="form-control" id ="zipCode">
	...
	<div class="form-group row">
	   <label class="col-sm-2">주소</label>
	     <div class="col-sm-5">
		<input type="text" id="addressName" placeholder="주소" name="addressName"><br>
	     </div>
	</div>
	<div class="form-group row">
